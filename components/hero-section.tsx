...
export default function HeroSection() {
  return (
    <section className="relative py-16 md:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-100 via-blue-50 to-pink-100"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div>
            <div className="mb-4">
              <span className="text-emerald-500 font-bold text-lg uppercase tracking-widest">Hire Dedicated</span>
            </div>

            <h1 className="text-6xl md:text-7xl font-bold text-slate-900 mb-6 leading-tight">Developers</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-3 bg-rose-400 text-white rounded-lg hover:bg-rose-500 font-semibold text-base transition flex items-center justify-center gap-2">
                ...
                <img src={ArrowBackIcon.src} alt="arrow back" className="w-6 h-6" />
              </button>
              <button className="px-8 py-3 border-2 border-emerald-500 text-emerald-600 rounded-lg hover:bg-emerald-50 font-semibold text-base transition flex items-center justify-center gap-2">
                Get In Touch
                <img src={ArrowForwardIcon.src} alt="arrow back" className="w-6 h-6" />
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Create Your Team</h3>
            <p className="text-gray-600 text-sm mb-8">Lorem Ipsum is simply dummy text of the printing</p>
            ...
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-gray-700 text-sm font-medium mb-2">Project Brief</label>
                <textarea
